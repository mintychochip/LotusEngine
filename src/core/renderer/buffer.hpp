...
namespace lotus
{
    ...
    public:
        Buffer(GLenum buffer_type, GLsizeiptr size, GLenum usage, const void *data = nullptr)
            : buffer_type_{buffer_type}, size_{size}, usage_{usage}
        {
            glGenBuffers(1, &id_);
            bind();
        ...
        */
        ...
        /*
            ...
            The size of 'data' is assumed to be the same size as the allocated buffer on the GPU.
